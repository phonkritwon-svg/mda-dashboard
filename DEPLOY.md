...
ข้อมูลอยู่ใน `navy-units.js` — 45 หน่วยงาน 9 หมวด ดึงจาก
https://www.navy.mi.th/organization เมื่อ 2026-08-25

**27 หน่วยมีอีเมล · 18 หน่วยไม่มี** (เว็บต้นทางใส่ "-") หน่วยที่ไม่มีอีเมลยังแสดงในรายการ
แต่กดเลือกไม่ได้ เพื่อให้เห็นว่ามีหน่วยนั้นอยู่จริงแต่ติดต่อทางเมลไม่ได้
