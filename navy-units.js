/* ============================================================
   ...
   ครบทั้ง 9 หมวด 45 หน่วยงาน ตามที่เว็บกองทัพเรือเผยแพร่

   ⚠ 18 หน่วยงานไม่มีอีเมลเผยแพร่ — เว็บต้นทางใส่ "-" ไว้
     รายการเหล่านั้น email เป็นสตริงว่าง หน้าเว็บจะแสดงแต่กดมอบหมายไม่ได้
     ตั้งใจเก็บไว้ทั้งหมดเพื่อให้เห็นว่ามีหน่วยนี้อยู่จริงแต่ติดต่อทางเมลไม่ได้
     ดีกว่าซ่อนทิ้งแล้วมีคนไปตามหาว่าทำไมไม่มี
  ...
  window.MDA_NAVY_UNITS = [
    {
      ...
      units: [
        ...
        U("กรมสารบรรณทหารเรือ", "", "02 475 4575", "https://www.admin.navy.mi.th/"),
    ...
    },
    {
      ...
      units: [
        ...
        U("ศูนย์ไทยอาสาป้องกันชาติในทะเล (ศูนย์ ทสปช.ในทะเล)", "", "0-3873-8966", ""),
        U("หน่วยเฉพาะกิจนาวิกโยธินกองทัพเรือ", "", "0 7356 5079", ""),
      ],
    },
    {
      cat: "หน่วยงานอื่น ๆ ส่วนกำลังรบ",
      units: [
        U("กองเรือตรวจอ่าว", "", "038-438006", "https://www.fleet.navy.mi.th/site/patrolsqdn"),
        U("หน่วยบัญชาการสงครามพิเศษทางเรือ กองเรือยุทธการ", "", "", "https://www.fleet.navy.mi.th/site/nswc"),
        U("กองเรือฟริเกตที่ ๑", "", "0-3843-9133", "https://www.fleet.navy.mi.th/site/frigate1"),
        U("กองเรือฟริเกตที่ ๒", "pop.kitkit@gmail.com", "", "https://www.fleet.navy.mi.th/site/frigate2"),
        U("กองเรือบรรทุกเฮลิคอปเตอร์", "", "038 432 100", "https://www.fleet.navy.mi.th/site/hch"),
        U("กองเรือดำน้ำ", "submarine_sq@navy.mi.th", "038-439117", "https://www.fleet.navy.mi.th/site/submarine"),
      ],
    },
    {
      cat: "หน่วยงานย่อยส่วนยุทธบริการ",
      units: [
        U("อู่ราชนาวีมหิดลอดุลยเดช กรมอู่ทหารเรือ", "", "", "https://www.dockyard.navy.mi.th/site/mnd"),
        U("ศูนย์บริหารข่าวสารการพัสดุ พธ.ทร.", "", "02-4755095", "https://www.supply.navy.mi.th/mmic/"),
        U("อู่ทหารเรือพระจุลจอมเกล้า กรมอู่ทหารเรือ", "", "", "https://www.dockyard.navy.mi.th/site/phrachulachomklao"),
        U("อู่ทหารเรือธนบุรี กรมอู่ทหารเรือ", "", "", "https://www.dockyard.navy.mi.th/site/thonburi"),
        U("ศูนย์ส่งกำลัง พธ.ทร.", "", "038-43565", "https://info.nsc.navy.mi.th/"),
      ],
    },
    {
      cat: "หน่วยงานย่อยส่วนบัญชาการ",
      units: [
        U("กองการกำลังพลสำรอง", "", "0-2465-5031", "http://www.person.navy.mi.th/reserve/navy.php"),
      ],
    },
    {
      cat: "หน่วยงานอื่น",
      units: [
        ...
        U("สำนักงานคณะกรรมการพัฒนาอาชีพทหารกองประจำการ กองทัพเรือ", "", "0-2-418-0320", ""),
        U("สำนักงานการกีฬากองทัพเรือ", "", "02-475-5774", "https://www.navysport.navy.mi.th/"),
        U("ศูนย์บรรเทาสาธารณภัยกองทัพเรือ", "", "074-325804", ""),
        U("สนามกอล์ฟราชนาวี พลูตาหลวง", "ptlnavy1969@gmail.com", "080 209 9175", "http://www.ptlnavygolf.navy.mi.th/"),
        U("ศูนย์พัฒนากีฬาราชนาวี ศาลายา", "", "02 475 3562", "https://www.navedu.navy.mi.th/navalgolfsalaya/"),
      ],
    },
  ];
