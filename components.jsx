...
const VTYPE = {
  ...
  /* เรือโดยสารแยกจากเรือสินค้า — เดิมรหัส 60-69 ถูกเหมาเป็น "เรือสินค้า"
     ซึ่งผิดความหมาย และผิดในทางที่สำคัญ: เรือโดยสารมีคนอยู่บนเรือ
     เวลาเกิดเหตุจึงมีลำดับความเร่งด่วนต่างจากเรือบรรทุกของ */
  passenger:{ color:"#33d6c8", label:{th:"เรือโดยสาร",en:"Passenger"} },
  tug:     { color:"#8fd14f", label:{th:"เรือลากจูง",en:"Tug / towing"} },
  other:   { color:"#9aa4b2", label:{th:"ประเภทอื่น",en:"Other type"} },
...
/* ── ข่าวที่เกิด "ในประเทศไทย" ────────────────────────────────────────
   ...
   ⚠ ภาษาไทยไม่มีช่องว่างคั่นคำ regex จึงไม่มีขอบเขตคำให้ยึด ชื่อจังหวัดสั้น ๆ
   ที่บังเอิญเป็นคำทั่วไปหรือเป็นส่วนหน้าของคำอื่นจึงห้ามใส่ลอย ๆ ต้องบังคับให้
   มีคำนำหน้า "จังหวัด/จ." เสมอ มิฉะนั้นข่าวเกือบทุกชิ้นจะถูกตัดสินว่าเป็นข่าวไทย:
     เลย  → "ไม่ได้เลย" (คำลงท้ายที่พบทั่วไป)
     น่าน → "น่านน้ำ"  (คำที่โผล่ในข่าวทางทะเลแทบทุกชิ้น)
     แพร่ → "แพร่ระบาด" · "เผยแพร่"
     ตาก  → "ตากอากาศ" · "ตากแดด"                                       */
const TH_AMBIGUOUS_PROVINCES = "(?:จังหวัด|จ\\.\\s?)(?:เลย|น่าน|แพร่|ตาก)";
